 ...
 *  
 *  -------------------------------------------------------------
 *  HOW TO HIDE A BLOG POST (The Safe Way):
 *  -------------------------------------------------------------
 *  Method 1 (Recommended): Wraps the block in comments.
 *  IMPORTANT: Make sure you don't break the commas!
 *  
 *  Example of a Hidden Post:
 *  
 *  /* 
 *  {
 *      id: 99,
 ...
 *  *\/
 *  
 *  (Note: Keep the comma inside the comment block to be safe).
 */

/* 
  // --- EXAMPLE HIDDEN POST (Uncomment to use) ---
  {
      id: 999, 
      type: "image",
      ...
      preview: "This post is hidden. Remove the /* and *\/ to show it.",
