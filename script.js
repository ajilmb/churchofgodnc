...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.minimizeInsectModal = function () {
        ...
        // 3. Add to Taskbar
        if (insectTaskbarContainer) {
            // Check if already exists
            if (document.getElementById('taskbarItem_Insect')) return;

            const taskItem = document.createElement('div');
            taskItem.className = 'taskbar-item';
            taskItem.id = 'taskbarItem_Insect';
            // Insect Icon for Taskbar
            taskItem.innerHTML = `
                 <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color: var(--primary-green);">
                    <path d="M12 2c0 3 2.5 5 5 5 2.5 0 5-2 5-5"></path>
                    <path d="M12 2c0 3-2.5 5-5 5-2.5 0-5-2-5-5"></path>
                    <circle cx="12" cy="13" r="5"></circle>
                    <path d="M12 18v4"></path>
                    <path d="M15.5 16.5l3 3"></path>
                    <path d="M8.5 16.5l-3 3"></path>
                 </svg>
